...
class Controls extends PApplet {
  ...
  public void randomData() { dataSource = RANDOM_DATA; }
  public void noData() { dataSource = NO_DATA; }
  public void streamData() { dataSource = STREAM_DATA; }
  public void touchHand() { handsTouching = !handsTouching; }
}